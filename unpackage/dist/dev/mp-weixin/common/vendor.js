...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"爱盼影视","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 14));var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 3));
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    setVideoPlayList: function setVideoPlayList(state, data) {
      state.videoPlayList = data;
    },
    setVideoPlayIndex: function setVideoPlayIndex(state, index) {
  ...
  getters: {
    ...
    nextVod: function nextVod(state) {
      var nextData = {
    ...
    prevVod: function prevVod(state) {
      var prevData = {
        index: state.videoPlayIndex - 1,
        data: state.videoPlayList[state.videoPlayIndex - 1] };
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! ./request.js */ 24));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var request = function request(config) {
  ...
  var cmsUrl = uni.getStorageSync('cmsUrl');
